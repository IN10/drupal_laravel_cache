...
class DrupalLaravelCacheController
{
  ...
  public function __construct()
  {
    ...
    self::$laravelUrl = $laravelSettings['base_url'] . $laravelSettings['cache_endpoint'];
  }
   ...
   */
  public static function invalidateCache($entity)
  {
    ...
    try {
      $client = new Client();
      $client->request('POST', self::$laravelUrl, [
        'form_params' => [
          'tags' => $bundle
        ]
      ]);
